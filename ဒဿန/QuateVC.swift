...
//  Copyright © 2017 AungThuPhyo. All rights reserved.
//
...
class QuateVC: UIViewController {
   ...
   func randomcolor() -> UIColor {
    ...
    func randomQuate(){
        ...
        case 3:
            quatesLabel.text = "တစ်ခုတည်းသော စစ်မှန်သည့် အသိပညာမှာ သင်မသိခြင်းကိုသိနေခြင်းဖြစ်သည်။"
        ...
        case 8:
            quatesLabel.text = "သူများကို ဘာလုပ်ပြီးပြီးလည်း မေးမယ့်အစား ..ကိုယ် ဘာလုပ်ပြီးပြီးလည်း အရင် ပြန်မေးကြည့်ပါ။"
